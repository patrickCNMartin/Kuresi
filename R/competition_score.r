...
#' @export
compute_competition_outcomes_old <- function(
    seed_assay,
    expressed,
    repressed = NULL,
    query_assay = NULL,
...
assign_score <- function(
  ...
  vesalius_assay <- vesalius:::update_vesalius_assay(
    vesalius_assay = vesalius_assay,
    data = trial,
    slot = "territories",
    append = TRUE
  )
