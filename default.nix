...
# with following call:
# >rix(r_ver = "81fcca105c297d4119f1e3358a05815aeffdcabd",
#  > r_pkgs = c("ggplot2",
#  > "patchwork",
#  > "ggpubr",
#  > "rjson",
...
#  > overwrite = TRUE,
#  > print = TRUE)
# It uses upstream nixpkgs' revision 81fcca105c297d4119f1e3358a05815aeffdcabd for reproducibility purposes
# which will install R version latest-upstream.
# Report any issues to https://github.com/ropensci/rix
let
 pkgs = import (fetchTarball "https://github.com/NixOS/nixpkgs/archive/81fcca105c297d4119f1e3358a05815aeffdcabd.tar.gz") { config.allowUnfree = true; };
